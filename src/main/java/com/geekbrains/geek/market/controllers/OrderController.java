...
//        spec = spec.and((Specification<OrderEntity>) (root, criteriaQuery, criteriaBuilder) ->
//                criteriaBuilder.greaterThanOrEqualTo(root.get("user"), user.getId()));
//        List<OrderEntity> orderList = orderService.findAll(spec);
...
//    }
    ...
    public void createNewOrder(@RequestParam String address, @RequestParam String phone, Principal principal) {
        ...
        OrderEntity order = new OrderEntity(user, cart, address, phone, principal.getName());
